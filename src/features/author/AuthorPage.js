        ...
        <Section
            ...
            body={
                <><p><strong>O mnie</strong></p>
                    <p>Moje szerokie zainteresowania obejmują różnorodne dziedziny.&nbsp;
                    ...
                    <p>Oprócz motoryzacji, regularnie dbam o swoją formę fizyczną.&nbsp;
                        <strong>Siłownia</strong> to miejsce, gdzie nie tylko wzmacniam ciało, ale i odpoczywam psychicznie. W połączeniu z <em>bieganiem</em>, pozwala mi utrzymywać dobrą kondycję i energię na najwyższym poziomie przez cały rok. W zimie natomiast, <em>jazda na nartach</em> daje mi możliwość aktywnego spędzenia czasu na świeżym powietrzu, co świetnie dopełnia moje sportowe pasje.</p>
